...
#define AXIS1_STEPS_PER_DEGREE     1664.0 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    547.556 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
