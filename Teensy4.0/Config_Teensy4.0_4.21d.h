...
#define BUZZER                        520 //    OFF, ON, n. Where n=100..6000 (Hz freq.) for piezo speaker. ON for buzzer.    Option
...
#define AXIS1_STEPS_PER_DEGREE     3328.0 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_IHOLD            450 //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS1_DRIVER_IRUN             600 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
#define AXIS1_DRIVER_IGOTO            950 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
#define AXIS2_STEPS_PER_DEGREE 1825.18518 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_IHOLD            450 //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS2_DRIVER_IRUN             600 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
#define AXIS2_DRIVER_IGOTO            950 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
...
#define AXIS2_LIMIT_MIN               -15 //    -90, n. Where n=-90..0 (degrees.) Minimum allowed declination.                Infreq
